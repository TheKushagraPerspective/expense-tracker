      ...
      try {
        ...
        if (response.data.success) {
          ...
          if (error.response && error.response.data && error.response.data.msg) {
            ...
            setError("Login Failed. Please check your credentials/internet or try again later.");
          }
      }
  }
  ...
  return (
    <>
      <div className="auth-page container parent w-full h-screen flex justify-center items-center">
        <div
          className="w-full max-w-md flex flex-col justify-center rounded-lg p-6 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 shadow-2xl text-white"
        >
          ...
          <div className="min-h-[310px] flex flex-col justify-between">
              {loginMethod === "password" ? <form onSubmit={handleOnLogin} className="space-y-4 mx-10">
                {error && (
              ...
              </form> : <form onSubmit={handleOngetOTP} className="space-y-4 mx-10">
